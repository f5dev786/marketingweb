      ...
      <section className="bg-[#0f172a] !text-white min-h-screen flex justify-center items-start px-6 py-10">
        <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12">
          ...
          <div className="sticky top-10 h-[80vh] scrollbar-hide  overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-transparent">
            <p className="text-[12px] bg-blue-100  tracking-widest text-blue-600  border border-dashed border-blue-600 rounded-2xl px-3 py-1 inline-block mb-4">
              Key Features
            </p>
            <h1 className="text-[42px] font-medium mt-3 leading-[1.2]">
              <span className="text-blue-500">IS-211</span> Temperature & Humidity Sensor
            </h1>
            <p className="mt-3 ">
              IS-211 is a Long Range LoRaWAN Sensor. It includes a built-in
              Temperature & Humidity sensor and has an external sensor connector
              to connect to an external Temperature Sensor.
            </p>
            ...
            <ul className="space-y-2 mt-3 ">
              ...
              {listItem("Built-in Temperature & Humidity sensor", "text-white")}
              {listItem(
            ...
            {/* Temperature Table */}
            <h3 className="mt-6 text-xl text-blue-500">Built-In Temperature Sensor</h3>
            <table className="mt-2 w-full border border-gray-500 ">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-500 p-3">&lt; 0.02 ℃/yr</td>
                </tr>
                <tr>
                  <td className="border border-gray-500 p-3">
                    Operating Range
            ...
            {/* Humidity Table */}
            <h3 className="mt-6 text-xl text-blue-500">Built-In Humidity Sensor</h3>
            <table className="mt-2 w-full border border-gray-500">
              <tbody>
                <tr>
                  <td className="border border-gray-500 p-3">Resolution</td>
